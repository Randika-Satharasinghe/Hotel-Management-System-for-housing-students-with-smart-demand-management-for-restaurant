    ...
    <div class="card shadow">
      <div class="card-header border-0">
        <div class="row align-items-center">
          <div class="col">
            <h3 class="mb-0">Today's Orders</h3>
          </div>
      ...
      <div class="table-responsive">
        ...
        <table class="table align-items-center table-flush">
          ...
          <tbody>
            ...
            // Modify the SQL query to fetch today's orders
            $ret = "SELECT * FROM rpos_orders WHERE DATE(created_at) = ? ORDER BY created_at DESC LIMIT 7";
