    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="category.php">
              <i class="ni ni-bullet-list-67 text-primary"></i>Category
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="predict.php">
              <i class="ni ni-cart text-primary"></i> Prediction
            </a>
          </li>
        ...
        <ul class="navbar-nav mb-md-3">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="static.php">
              <i class="fas fa-shopping-basket"></i> Today Popularity
            </a>
          </li>
        </ul>
        <hr class="my-3">
