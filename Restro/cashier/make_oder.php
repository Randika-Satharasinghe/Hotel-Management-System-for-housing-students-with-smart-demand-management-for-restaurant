...
<body>
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" name="customer_id" id="custID" onChange="getCustomerName(this.value)">
                      ...
                      ?>
                        <option value="<?php echo $cust->customer_id; ?>"><?php echo $cust->customer_id; ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="customer_name" id="customerName" class="form-control" value="">
                  </div>
  ...
  <script>
    function getCustomerName(customerId) {
      // Update the "Customer Name" field with the fetched customer name
      document.getElementById("customerName").value = ""; // Clear the field first (optional)
      fetch(`get_customer_name.php?customer_id=${customerId}`)
